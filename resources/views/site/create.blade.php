...
<p class="text-white my-3 text-lg">
    Crie uma página para surpreender o aniversáriante, com uma apresentação de <span class="font-bold">imagens</span>, uma mensagem de aniversário e uma
    <span class="font-bold">música</span> de sua escolha!<br>
    Você também recebera um <span class="font-bold">QR Code</span> para compartilhar o site!
</p>
<form action="{{ route('stripe.checkout') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="flex flex-col mb-3">
        ...
        <input type="url" name="music" id="music" class="p-2 rounded-lg border-2 border-yellow-300" placeholder="https://www.youtube.com/watch?v=AWiGJBIFJSc" value="{{ old('music') }}">
        @if ($errors->has('music'))
    ...
    <div class="bg-gray-200 p-1 rounded-lg shadow-lg my-3 text-center font-bold border-2 border-yellow-300 border-dashed">Duração de 6 meses, por apenas R$9.99</div>
